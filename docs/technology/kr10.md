...
- **Extruder Diagram:** [View here](https://fabacademy.org/2024/labs/hopelab/students/luis-pacheco/assets/images/outputs/wiring.png)  
- **Technical Details:** [View PDF](https://www.kuka.com/-/media/kuka-downloads/imported/8350ff3ca11642998dbdc81dcc2ed44c/0000210360_en.pdf)  
- **Official Handbook:** Available in Room 131 (handbooks drawer).  
- **Extruder Control Code:** [Download]({{ site.baseurl }}/assets/images/kukakr10/Extruder-Control-Code.txt)  
...
- Ensure you read the checklist file.
  ...
  ![Checklist]({{ site.baseurl }}/assets/images/kukakr10/KUKA10_1.jpg){: style="width: 50%;" }

- The numbers in the image correspond to the instructions below.

  ![Markdown]({{ site.baseurl }}/assets/images/kukakr10/KUKA10_Markdown.JPG){: style="width: 50%;" }
...
1. Power the arm using the **green switch** on the control box. This will also turn on the teach pendant.
   ...
   ![Button]({{ site.baseurl }}/assets/images/kukakr10/KUKA10_2.JPG){: style="width: 20%;" }
...
6. Adjust the **robot speed (4)** (starts at 0 for safety).
...
3. Set the **Black switch (1)** back to **automatic**.
